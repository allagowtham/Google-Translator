...
LanguageChoices = {'Hindi','English','French','German','Spanish','Telugu','Korean'}
...
Label(Screen,text="Choose a Language",fg="blue").grid(row=0,column=1)
InputLanguageChoiceMenu.grid(row=1,column=1)

#choice in which the language is to be translated
NewLanguageChoiceMenu = OptionMenu(Screen,TranslateLanguageChoice,*LanguageChoices)
Label(Screen,text="Translated Language",fg="blue").grid(row=0,column=2)
